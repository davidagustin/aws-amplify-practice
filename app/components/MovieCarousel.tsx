  ...
  return (
    <div className="relative group">
      ...
      {showLeftArrow && (
        <button
          onClick={() => scroll('left')}
          className="absolute left-2 top-1/2 -translate-y-1/2 z-20 bg-black bg-opacity-80 hover:bg-opacity-100 p-2 rounded-full transition-all opacity-0 group-hover:opacity-100 shadow-lg"
        >
      ...
      {showRightArrow && (
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 z-20 bg-black bg-opacity-80 hover:bg-opacity-100 p-2 rounded-full transition-all opacity-0 group-hover:opacity-100 shadow-lg"
        >
